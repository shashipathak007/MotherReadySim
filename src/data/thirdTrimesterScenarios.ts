...
export const THIRD_TRIMESTER_SCENARIOS: Scenario[] = [
  {
    ...
    options: [
      ...
      { text: "Counting contractions", textNe: "संकुचन गन्ने", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She ate too quickly and it will pass", textNe: "उनले चाँडो खाइन् र यो जान्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "It means the baby will be born earlier", textNe: "बच्चा चाँडो जन्मिन्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "The doctor made a mistake calculating the due date", textNe: "डाक्टरले नियत मिति गणना गर्दा गल्ती गर्नुभयो", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Only spicy food is effective", textNe: "पिरो खाना मात्र प्रभावकारी छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "GBS is not a real condition", textNe: "GBS वास्तविक रोग होइन", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Only if the baby stops moving", textNe: "बच्चा हल्लिन बन्द गरेमा मात्र", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Her waters have broken", textNe: "उनको पानी फुटेको छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She should take sleeping tablets to calm down", textNe: "शान्त हुन निद्राको औषधि खाने", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "At 40 weeks, the due date", textNe: "४० हप्तामा, नियत मितिमा", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She is out of shape and needs to exercise more", textNe: "उनी फिट छैनन् र बढी व्यायाम चाहिन्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Vaccines are not safe during pregnancy", textNe: "गर्भावस्थामा खोप सुरक्षित छैन", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She needs compression stockings from the hospital immediately", textNe: "तुरुन्तै अस्पतालबाट कम्प्रेसन स्टकिंग्स चाहिन्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Whether the mother needs more fruit in her diet", textNe: "आमालाई आहारमा बढी फलफूल चाहिन्छ कि भनेर", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "The mother should always decide when labour starts", textNe: "प्रसव कहिले सुरु गर्ने भन्ने आमाले सधैं निर्णय गर्नुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Do nothing — labour will not happen early", textNe: "केही नगर्ने — प्रसव चाँडो हुँदैन", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Any position is equally safe", textNe: "कुनै पनि स्थिति समान रूपमा सुरक्षित", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "A plan for which hospital to drive to", textNe: "कुन अस्पतालमा जाने भन्ने योजना", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She should switch to a liquid diet only", textNe: "तरल आहारमा मात्र जानुपर्छ", isCorrect: false }
    ],
