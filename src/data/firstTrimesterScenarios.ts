...
export const FIRST_TRIMESTER_SCENARIOS: Scenario[] = [
  {
    ...
    options: [
      ...
      { text: "Drink a large glass of cold water first thing in the morning", textNe: "बिहान उठ्ने बित्तिकै ठूलो गिलास चिसो पानी पिउने", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "They prevent leg cramps", textNe: "यसले खुट्टा बाउँडिनबाट जोगाउँछ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Take a painkiller and wait 2 days", textNe: "दुखाइ कम गर्ने औषधि खाने र २ दिन पर्खने", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Switch from coffee to energy drinks instead", textNe: "कफीको सट्टा इनर्जी ड्रिंक्स पिउन थाल्ने", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "No — she needs to eat less to prevent weight gain", textNe: "होइन — तौल बढ्न नदिन उनले कम खानुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She must ask her doctor before doing any movement at all", textNe: "उनले कुनै पनि चलखेल गर्नुअघि डाक्टरलाई सोध्नुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "All three are equally dangerous", textNe: "यी तीनवटै उत्तिकै खतरनाक छन्", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She must get a doctor's note to continue working", textNe: "काम जारी राख्न उनले डाक्टरको अनुमति लिनुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "At the 5th month for the ultrasound", textNe: "भिडियो एक्सरेको लागि ५ औं महिनामा", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She is eating too much and needs to diet", textNe: "उनी धेरै खाइरहेकी छिन् र उनले खाना कम गर्नुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "No — she needs to reduce screen time before bed", textNe: "होइन — उनले सुत्नुअघि मोबाइल वा टिभी हेर्न कम गर्नुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "It is a sign of gestational diabetes", textNe: "यो गर्भावस्थाको मधुमेहको लक्षण हो", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Only from the 6th month onward", textNe: "६ औं महिना पछि मात्र", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "She should take them only if they taste bitter", textNe: "यदि ती तितो छन् भने मात्र उनले खानुपर्छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "To check if the mother needs a C-section", textNe: "आमालाई शल्यक्रिया (C-section) चाहिन्छ कि भनेर जाँच्न", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "One or two cigarettes per week is completely harmless", textNe: "हप्तामा एक वा दुईवटा चुरोट पिउनु पूर्णतया हानिरहित छ", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Only in the third trimester", textNe: "तेस्रो त्रैमासिकमा मात्र", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Announcing early causes complications", textNe: "चाँडै सुनाउँदा समस्याहरू आउँछन्", isCorrect: false }
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { text: "Only sitting upright", textNe: "बसेर मात्र", isCorrect: false }
    ],
  ...
  },
  {
    ...
    descriptionNe: "संगीता ७ हप्ताकी गर्भवती छिन्। वाकवाकी र कम खानपानका कारण उनको १ किलो तौल घटेकोले उनका श्रीमान चिन्तित हुनुहुन्छ।",
    options: [
      ...
      { text: "She needs to stop all activities immediately", textNe: "उनले तुरुन्तै सबै काम बन्द गर्नुपर्छ", isCorrect: false }
    ],
